...
from my_dbt import dbt_bronze, dbt_silver, dbt_gold, dbt_all, dbt_bronze_run_op, dbt_silver_run_op, dbt_gold_run_op, dbt_bronze_test_doc_sources_op, dbt_silver_test_doc_sources_op, dbt_gold_test_doc_sources_op
from predict import predict_op

@job(resource_defs={
    'my_dbt': DbtCliResource(project_dir='project_dir', profiles_dir='profiles_dir'), 
